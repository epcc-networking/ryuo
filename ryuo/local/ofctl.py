...
from ryuo.config import OPEN_VSWITCH_MODE
    ...
    def set_async_config(self, packet_in_mask=None, port_status_mask=None,
        ...
        if OPEN_VSWITCH_MODE:
            ...
            properties = [
                ...
                self.ofp_parser.OFPAsyncConfigPropReasons(
                    self.ofp.OFPACPT_PORT_STATUS_MASTER,
                    mask=port_status_mask),
                self.ofp_parser.OFPAsyncConfigPropReasons(
                    self.ofp.OFPACPT_FLOW_REMOVED_MASTER,
                    mask=flow_removed_mask)]
